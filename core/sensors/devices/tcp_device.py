...
class TcpDevice:
    def __init__(self, host: str = "192.168.4.1", port: int = 12345):
        """
        :param host: IP address of the ESP32 web.
        :param port: Port number of the ESP32 web.
        """
        self.host = host
        self.port = port
    ...
    def send_command(self, command: str):
        ...
        if not self.client_socket:
            print("Error: Not connected to the web")
            return
    ...
    def set_data_handler(self, handler: Callable[[str], None]):
        """
        :param handler: Function that takes a string as controlls.
        """
    ...
    def _receive_data(self):
        try:
            while self.running:
                ...
                if not data:
                    print("Server closed the sensors")
                    break
